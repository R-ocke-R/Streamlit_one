...
with col1:
    with st.expander("Why ?"):
        st.write("""I chose this project based on a video featuring William Ackman, founder and CEO of Pershing Square Capital Management. In the [video](%s), Ackman introduces finance and investing in under an hour. My mentor shared this video with me during a discussion about whether to delay my masters by a year. 
...
with col2:
    with st.expander("How?"):
        st.write("""This interactive web app is made via [Streamlit](%s), a Python library. Taking inspiration from the investing lecture, Streamlit provided the perfect platform for translating my idea into a functional and user-friendly interface.  By combining my creativity with the capabilities of Streamlit, 
                I was able to design, code, and deploy this web app with ease.""" % stdocs)
with col3:
    with st.expander("Video Source"):
...
# Currency type input
currency_type = st.selectbox('Select Currency Type', ['USD', 'EUR', 'GBP'])

# Amount input
amount = st.number_input(f'Enter Amount in {currency_type}', min_value=0.01, step=0.01)
